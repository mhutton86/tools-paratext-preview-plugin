...
namespace TptPublish
{
    ...
    class PluginPublisherProgram
    {
        ...
        /// </summary>
        const string PluginTargetFilename = "TypesettingPreviewPlugin";
        ...
        static readonly string PluginArchivePath = Path.Combine(SolutionRootPath, "bin", PluginArchiveFilename);
